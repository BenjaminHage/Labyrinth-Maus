...
class DifferentialDriveRobot:
    def __init__ (self, param_file = '/home/be161hag/Labyrinth-Maus/parameters.txt', mesurment_noise_mean = 0, mesurment_noise_standard_deviation = 1, system_noise_mean = 0, system_noise_standard_deviation = 1, 
